...
const TrendingCareers = () => {
    const careers = [
      { title: "Data Scientist", img: "/images/1.png", desc: "Explore the world of data and analytics." },
      { title: "Web Developer", img: "/images/5.png", desc: "Build responsive and modern websites." },
      { title: "Product Manager", img: "/images/9.jpg", desc: "Design intelligent systems with AI." },
      { title: "AI Engineer", img: "/images/14.png", desc: "Lead products to success." },
      { title: "UX Designer", img: "/images/cer.jpg", desc: "Create user-friendly designs." },
    ];
    return (
